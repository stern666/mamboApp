            ...
            function (transaction, result) {
                ...
                if (result.rows.length) {
                    ...
                    for (var i = 0; i < result.rows.length; i++) {
                        ...
                        $("#txtFechaEmision").val(rowDb.documentDate.substring(0, 16));
                        //$("#txtHoraEmision").val(rowDb.hora_entrega);
                        $("#txtFechaEntrega").val(rowDb.deliveryDate.substring(0, 10));
                       // $("#txtEstadoPedido").val(rowDb.estado);
                        preu = Math.round(rowDb.amount * 100) / 100
                        $("#txtValorPedido").val(preu + " €");
...
function pMostrarCabeceraPedido() {
    ...
    $("#ptxtFechaEmisionCabecera").val(getCurrentTime()); //Temporal, hay que cambiar por la actual
                    ...
                    transaction.executeSql(sql, undefined,
                        function (transaction, result) {
                            ...
                            if (result.rows.length > 0) {
                                ...
                                console.log("----------------------------------------------------------------------------");
                                console.log(rowDb1.fechaEntrega);
